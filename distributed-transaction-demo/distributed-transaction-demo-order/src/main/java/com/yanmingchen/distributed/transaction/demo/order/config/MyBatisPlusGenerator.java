...
package com.yanmingchen.distributed.transaction.demo.order.config;
...
public class MyBatisPlusGenerator {
	...
	private static final String PROJECT_PATH = "D:/code/tx_order";
	...
	private static void packageConfig(AutoGenerator mpg) {
		...
		pc.setParent("com.yanmingchen.distributed.transaction.demo.order");
		pc.setEntity("entity");
		pc.setMapper("mapper");
	...
	private static void dataSourceConfig(AutoGenerator mpg) {
		...
		dsc.setUrl(
				"jdbc:mysql://47.104.171.230:3306/tx_order?useUnicode=true&useSSL=false&characterEncoding=utf8");
