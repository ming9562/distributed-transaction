package com.cym.distributed.transaction.demo.ui.config;
...
public class Swagger2 {
	...
	public Docket createRestApi() {
		...
		return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo()).select()
				.apis(RequestHandlerSelectors.basePackage("com.cym.distributed.transaction.demo.ui")).paths(PathSelectors.any())
